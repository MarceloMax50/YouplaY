...
namespace YouPlay2019.Controllers
{
    public class AlunoController : PadraoController<AlunoViewModel>
    {
        ...
        //{
        //    var aluno = from m in _context.AlunoViewModel
        //                select m;
        ...
        protected override void ListagemViewBag()
        {
            ...
            List<BagSelectViewModel> listagemDisciplinas = DAO.ListagemSelect("disciplina");

            ViewBag.Disciplinas = listagemDisciplinas;
